...
export const metadata: Metadata = {
  ...
  description:
    "David R. Fajardo - Expert Full-Stack Developer and Software Engineer from Caloocan City, Philippines. Specializing in Next.js, React, TypeScript, Node.js, and modern web development. Creator of SDK-TURBOREPO-STARTUP-EDITION — a production-ready monorepo with 6 apps and 17 packages. Available for freelance and full-time opportunities.",
  keywords: [
    "David Fajardo",
    "David R. Fajardo",
    "David R Fajardo",
    ...
    "Full-Stack Monorepo Kit",
    "React Native Monorepo",
    "Electron Monorepo Starter",
    "Production-Ready Monorepo",
    "Startup Developer Kit",
    "Ship Apps Faster",
    "Buy Developer Starter Kit",
    "One-Time Payment SDK",
    "Turborepo Template Commercial",
  ],
  authors: [
    {
  ...
  openGraph: {
    ...
    description:
      "David R. Fajardo - Expert Full-Stack Developer from Philippines. Creator of SDK-TURBOREPO-STARTUP-EDITION. Specializing in Next.js, React, TypeScript, Node.js. 10+ projects delivered. Available for freelance and full-time opportunities.",
    images: [
      {
...
const jsonLd = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      "@id": `${siteUrl}/store/#product`,
      name: "SDK-TURBOREPO-STARTUP-EDITION",
      applicationCategory: "DeveloperApplication",
      operatingSystem: "Cross-platform",
      description:
        "Production-ready Turborepo monorepo with 6 apps (Next.js, React Native, Electron, Hono API, Admin, Docs) and 17 shared packages. One-time payment, save $1,000+ in development time.",
      url: `${siteUrl}/store`,
      image: `${siteUrl}/products/sdk_turborepo_main_banner.png`,
      screenshot: `${siteUrl}/products/sdk_turborepo_main_banner.png`,
      softwareVersion: "1.0",
